...
const navItems = [
  { href: "/manager/dashboard", label: "数据看板", icon: LayoutDashboard },
  { href: "/manager/members", label: "成员管理", icon: Users },
];
...
export function ManagerSidebarNav({ userName, enterpriseName }: ManagerSidebarNavProps) {
      ...
      <div className="px-3 py-3 border-t border-border">
        <div className="flex items-center gap-2 px-2 py-2 rounded-lg">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground">团队管理者</p>
          </div>
        </div>
